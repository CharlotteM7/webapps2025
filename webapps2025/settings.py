...
SECRET_KEY = 'django-insecure-2j5bunfy35d&#6t=*u(+1_&oox!boln868774dv6=2*wd*qdhr'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['204.236.208.127', '204.236.208.127:8080', 'localhost', '*']
